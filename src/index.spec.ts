...
import {BIGINT_ENABLED, BRIDGE_TO_PORTS, DEFAULT_PORT, F1TelemetryClient,} from './index';
      ...
      describe('when no parameters are passed', () => {
        ...
        it('should set default port, forwardPorts and bigintEnabled to default values',
           () => {
             ...
             expect(f1TelemetryClient.forwardPorts).toBe(BRIDGE_TO_PORTS);
    ...
    describe('2020 format', () => {
      ...
      describe('handleMessage', () => {
        ...
        describe('PacketFinalClassificationData', () => {
          ...
          it('should parse PacketFinalClassificationData buffer', () => {
            expect(f1TelemetryClient.socket!.send)
                .toHaveBeenCalledWith(base64Encoder.encode(buffer));
          });
        });
      });
