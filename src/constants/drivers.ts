...
export const DRIVERS: {[index: number]: Driver} = {
  ...
  10: {abbreviation: 'HUL', firstName: 'Nico', lastName: 'Hulkenburg'},
  11: {abbreviation: 'MAG', firstName: 'Kevin', lastName: 'Magnusson'},
  12: {abbreviation: 'GRO', firstName: 'Roman', lastName: 'Grosjean'},
  13: {abbreviation: 'VET', firstName: 'Sebastien', lastName: 'Vettel'},
  14: {abbreviation: 'PER', firstName: 'Sergio', lastName: 'Perez'},
  15: {abbreviation: 'BOT', firstName: 'Valterie', lastName: 'Bottas'},
  17: {abbreviation: 'OCO', firstName: 'Esteban', lastName: 'Ocon'},
  18: {abbreviation: 'VAN', firstName: 'Stoffel', lastName: 'Vandorne'},
