...
*/
class CarSetupData extends F1Parser_1.default {
    constructor() {
        super();
        this.uint8("m_tractionControl")
            ...
            .array("m_tyresWear", {
            length: 4,
            type: new binary_parser_1.Parser().uint8("m_tyresWear")
        })
            .uint8("m_tyreCompound")
            .array("m_tyresDamage", {
            length: 4,
            type: new binary_parser_1.Parser().uint8("m_tyresDamage")
        })
...
exports.default = CarSetupData;
//# sourceMappingURL=CarStatusData.js.map