...
*/
class CarTelemetryData extends F1Parser_1.default {
    constructor() {
        super();
        this.uint16le("m_speed")
            ...
            length: 4,
            type: new binary_parser_1.Parser().uint16le("m_brakesTemperature")
        })
            .array("m_tyresSurfaceTemperature", {
            length: 4,
            type: new binary_parser_1.Parser().uint16le("m_tyresSurfaceTemperature")
        })
            .array("m_tyresInnerTemperature", {
            length: 4,
            type: new binary_parser_1.Parser().uint16le("m_tyresInnerTemperature")
        })
            .uint16le("m_engineTemperature")
            .array("m_tyresPressure", {
            length: 4,
            type: new binary_parser_1.Parser().floatle("m_tyresPressure")
        });
    }
}
exports.default = CarTelemetryData;
//# sourceMappingURL=CarTelemetryData.js.map